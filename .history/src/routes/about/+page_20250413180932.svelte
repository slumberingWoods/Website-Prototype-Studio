    ...
    <div class="mx-4 lg:mx-12 flex flex-col items-center bg-slate-400 h-fit">
        <div class="my-12">
            <div class="text-center">
                ...
                <div
                    class="flex flex-col lg:flex-row items-center justify-center bg-neutral-900/35 w-full mt-12 mb-6 lg:mb-12"
                >
            ...
            <div class="">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 my-12 lg:mx-36">

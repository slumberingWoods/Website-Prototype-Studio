<script lang="ts">
    ...
    const featured = date_sorted.slice(0,1) as unknown as Article;
</script>
            ...
            <div class="">
                <div class="hero bg-base-200">
                    <div class="hero-content flex-col lg:flex-row">
                        ...
                        />
                        <div>
                            <h1 class="text-5xl font-bold">{featured.metadata.title}</h1>
                            <p class="py-6">
                                {featured.metadata.description}
                            </p>
                            <a class="btn btn-primary" href={localizeHref("/blog_alt/" + featured.metadata.url)} aria-label={featured.metadata.title}>Read More</a>
                        </div>
                    </div>
                </div>
                <div

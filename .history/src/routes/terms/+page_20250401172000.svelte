    ...
    <div class="mx-12 flex flex-col justify-center items-center bg-slate-400 h-screen">
        <div class="content-center grow-7">
            <div class="text-center">
                ...
                <br>
                <p class="">{m["homepage.motto"]()}</p>
            </div>
        </div>
        <div class="text-center content-center grow-2">
            <form>
                <p class="footer-title text-base">{m["homepage.newsletter"]()}</h6>
                <fieldset class="w-80">
                    <div class="join">
                    <input
                    type="text"
                    ...
                    <button class="btn btn-primary join-item bg-slate-600">{m["homepage.newsletter"]()}</button>
                </div>
            </fieldset>
        </form>
        </div>

...
<nav>
    <div class="navbar h-20 lg:h-fit bg-slate-900 shadow-sm content-center">
        ...
        <div class="overflow-hidden navbar-end flex mx-12 content-center">
            ...
            <ul
                class="hidden lg:visible menu menu-horizontal bg-slate-800 rounded-box"
            >
                <li>
                    <a
            ...
            <ul>
                <div class="hidden lg:visible ml-4">
